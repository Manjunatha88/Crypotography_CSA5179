...
int main() {
    int i, j, k, numstr[MAX_LENGTH], numcipher[MAX_LENGTH], numkey[MAX_LENGTH], lenkey, templen, tempkey[MAX_LENGTH], flag = -1, size, cipherkey[5][5], lennumstr, row1, row2, col1, col2;
    ...
    printf("Entered key converted according to Playfair Cipher rule:\n");
    for (i = 0; i < lenkey; i++) {
        printf("%c", numkey[i] + 'A');
    }
    printf("\n");
    ...
    printf("Entered String/Message After Processing according to Playfair cipher rule:\n");
